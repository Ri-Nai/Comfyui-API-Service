...
request_data = {
    ...
    "positive_prompt": "cyberpunk, red light eyes, mechanic body.laser in eyes",
    ...
    "checkpoint_name": "AnythingXL_xl.safetensors",
    "controlnet_name": "controlnet-sd-xl-1.0-softedge-dexined.safetensors",
    "lora_names": ["vg.safetensors", "Neon_Vaporwave_IL.safetensors"],
